...
public class FarField extends EMobject{
    ...
    public FarField(double start,double stop,int count){
        ...
        thetaStepsCount = theta.length;
        phiStepsCount = phi.length;
    }
    ...
    public void saveFarFieldThetaPhiPattern(String cut){
        Common.save2DArray(farfield_dataPhi, "FarFieldPhiPattern".concat(cut));
        Common.save2DArray(farfield_dataTheta, "FarFieldThetaPattern".concat(cut));
        Common.save1DArray(phi, "FarFieldPhi");
        Common.save1DArray(theta, "FarFieldTheta");
    }
    

    public void calFarField2D(){ 
    ...
    public void saveFarFieldThetaPhi3DPattern(String FarFieldPhiPattern,String FarFieldThetaPattern,String FarFIeldPhi,String FarFieldTheta){
        ...
        for (int freqIndex = 0;freqIndex<this.frequencies.length;freqIndex++){
            ...
            Common.save2DArray(dataPhi, FarFieldPhiPattern.concat(String.valueOf(freqIndex)));
            Common.save2DArray(dataTheta, FarFieldThetaPattern.concat(String.valueOf(freqIndex)));
        }
        Common.save1DArray(phi, FarFIeldPhi);
        Common.save1DArray(theta, FarFieldTheta);
    }
