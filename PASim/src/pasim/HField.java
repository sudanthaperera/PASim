...
public class HField extends Field{
    ...
    public void updateHFieldWithPBC(){
	for (int i=0; i<nx+1; i++){
	    for (int j=0; j<ny; j++){
		for (int k=0; k<nz; k++){
                    if(b.getPBCY() && j == ny-1 && k != nz-1)
                        Hx[i][j][k] = Chxh[i][j][k]*Hx[i][j][k] + Chxey[i][j][k]*(Ey[i][j][k+1] - Ey[i][j][k]) + Chxez[i][j][k]*(Ez[i][0][k] - Ez[i][j][k]);
                    else if (b.getPBCZ() && j != ny-1 && k == nz-1)
                        Hx[i][j][k] = Chxh[i][j][k]*Hx[i][j][k] + Chxey[i][j][k]*(Ey[i][j][0] - Ey[i][j][k]) + Chxez[i][j][k]*(Ez[i][j+1][k] - Ez[i][j][k]);
                    else if (b.getPBCY() && b.getPBCZ() && j == ny-1 && k == nz-1)
                        Hx[i][j][k] = Chxh[i][j][k]*Hx[i][j][k] + Chxey[i][j][k]*(Ey[i][j][0] - Ey[i][j][k]) + Chxez[i][j][k]*(Ez[i][0][k] - Ez[i][j][k]);
                    else
                        Hx[i][j][k] = Chxh[i][j][k]*Hx[i][j][k] + Chxey[i][j][k]*(Ey[i][j][k+1] - Ey[i][j][k]) + Chxez[i][j][k]*(Ez[i][j+1][k] - Ez[i][j][k]);
		}
	    }
	...
	for (int i=0; i<nx; i++){
		...
		for (int k=0; k<nz; k++){
                    if (b.getPBCX() && i == nx-1 && k != nz-1)
                        Hy[i][j][k] = Chyh[i][j][k]*Hy[i][j][k] + Chyez[i][j][k]*(Ez[0][j][k] - Ez[i][j][k]) + Chyex[i][j][k]*(Ex[i][j][k+1] - Ex[i][j][k]);
                    else if (b.getPBCZ() && i != nx-1 && k == nz-1)
                        Hy[i][j][k] = Chyh[i][j][k]*Hy[i][j][k] + Chyez[i][j][k]*(Ez[i+1][j][k] - Ez[i][j][k]) + Chyex[i][j][k]*(Ex[i][j][0] - Ex[i][j][k]);
                    else if (b.getPBCX() && b.getPBCZ() && i == nx-1 && k == nz-1)
                        Hy[i][j][k] = Chyh[i][j][k]*Hy[i][j][k] + Chyez[i][j][k]*(Ez[0][j][k] - Ez[i][j][k]) + Chyex[i][j][k]*(Ex[i][j][0] - Ex[i][j][k]);
                    else
                        Hy[i][j][k] = Chyh[i][j][k]*Hy[i][j][k] + Chyez[i][j][k]*(Ez[i+1][j][k] - Ez[i][j][k]) + Chyex[i][j][k]*(Ex[i][j][k+1] - Ex[i][j][k]);
		}
	    }
	...
	for (int i=0; i<nx; i++){
		...
		for (int k=0; k<nz+1; k++){
                    if (b.getPBCX() && i == nx-1 && j != ny-1)
                        Hz[i][j][k] = Chzh[i][j][k]*Hz[i][j][k] + Chzex[i][j][k]*(Ex[i][j+1][k] - Ex[i][j][k]) + Chzey[i][j][k]*(Ey[0][j][k] - Ey[i][j][k]);
                    else if (b.getPBCY() && i != nx-1 && j == ny-1)
                        Hz[i][j][k] = Chzh[i][j][k]*Hz[i][j][k] + Chzex[i][j][k]*(Ex[i][0][k] - Ex[i][j][k]) + Chzey[i][j][k]*(Ey[i+1][j][k] - Ey[i][j][k]);
                    else if (b.getPBCX() && b.getPBCY() && i == nx-1 && j == ny-1)
                        Hz[i][j][k] = Chzh[i][j][k]*Hz[i][j][k] + Chzex[i][j][k]*(Ex[i][0][k] - Ex[i][j][k]) + Chzey[i][j][k]*(Ey[0][j][k] - Ey[i][j][k]);
                    else
                        Hz[i][j][k] = Chzh[i][j][k]*Hz[i][j][k] + Chzex[i][j][k]*(Ex[i][j+1][k] - Ex[i][j][k]) + Chzey[i][j][k]*(Ey[i+1][j][k] - Ey[i][j][k]);
