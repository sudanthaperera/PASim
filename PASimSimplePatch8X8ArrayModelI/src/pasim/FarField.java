...
public class FarField{
    ...
    public Complex[][][][] cjxyp(){
        return cjxyp;
    }
    
    public Complex[][][][] cjxzp(){
        return cjxzp;
    }
    
    public Complex[][][][] cjyxp(){
        return cjyxp;
    }
    
    public Complex[][][][] cjyzp(){
        return cjyzp;
    }
    
    public Complex[][][][] cjzxp(){
        return cjzxp;
    }
    
    public Complex[][][][] cjzyp(){
        return cjzyp;
    }
    
    public Complex[][][][] cjxyn(){
        return cjxyn;
    }
    
    public Complex[][][][] cjxzn(){
        return cjxzn;
    }
    
    public Complex[][][][] cjyxn(){
        return cjyxn;
    }
    
    public Complex[][][][] cjyzn(){
        return cjyzn;
    }
    
    public Complex[][][][] cjzxn(){
        return cjzxn;
    }
    
    public Complex[][][][] cjzyn(){
        return cjzyn;
    }
    
    public Complex[][][][] cmxyp(){
        return cmxyp;
    }
    
    public Complex[][][][] cmxzp(){
        return cmxzp;
    }
    
    public Complex[][][][] cmyxp(){
        return cmyxp;
    }
    
    public Complex[][][][] cmyzp(){
        return cmyzp;
    }
    
    public Complex[][][][] cmzxp(){
        return cmzxp;
    }
    
    public Complex[][][][] cmzyp(){
        return cmzyp;
    }
    
    public Complex[][][][] cmxyn(){
        return cmxyn;
    }
    
    public Complex[][][][] cmxzn(){
        return cmxzn;
    }
    
    public Complex[][][][] cmyxn(){
        return cmyxn;
    }
    
    public Complex[][][][] cmyzn(){
        return cmyzn;
    }
    
    public Complex[][][][] cmzxn(){
        return cmzxn;
    }
    
    public Complex[][][][] cmzyn(){
        return cmzyn;
    }
    ...
    public void CalculateJandM(int timeIndex, EField E, HField H,Boundary b){
        if(this.farFieldDisable){
            return;
        }
	...
	if (frequencies.length > 0 && b.getPBCX()==false){
	    for(int i = li; i <= ui; i++){
		for (int j = lj; j <= uj; j++){
		    for (int k = lk; k <= uk; k++){
			if (i == ui && j != uj && k != uk){
        ...
        if (frequencies.length > 0 && b.getPBCY()==false){
	    for(int i = li; i <= ui; i++){
		for (int j = lj; j <= uj; j++){
		    for (int k = lk; k <= uk; k++){
			if (i != ui && j == uj && k != uk){
        ...
        if (frequencies.length > 0 && b.getPBCZ()==false){
	    for(int i = li; i <= ui; i++){
		for (int j = lj; j <= uj; j++){
		    for (int k = lk; k <= uk; k++){
			if (i != ui && j != uj && k == uk){
