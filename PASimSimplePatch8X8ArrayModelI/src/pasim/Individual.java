...
public class Individual {
    ...
    public Individual(int chromosomeLength, int[] chromosomePatch, int[] chromosomePort) {
        this.chromosome = new int[chromosomeLength];
        for(int i=0;i<chromosomePatch.length;i++){
            this.chromosome[i] = chromosomePatch[i];
        }
        
        for(int j=chromosomePatch.length;j<chromosomePort.length+chromosomePatch.length;j++){
            this.chromosome[j] = chromosomePort[j-chromosomePatch.length];
        }
    }
