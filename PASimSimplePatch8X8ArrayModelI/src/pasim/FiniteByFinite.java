...
public class FiniteByFinite implements Runnable {
    ...
    private int arraySideCount;
    public Thread t;
    
    public FiniteByFinite(Cell c){
    ...
    public int arraySideCount(){
        return arraySideCount;
    }
    ...
    private void defineGeometry(){
        ...
        bricks[1].Xmin(-4*27.0e-3);
        bricks[1].Ymin(-4*27.0e-3);
        bricks[1].Zmin(-1.5e-3);
        bricks[1].Xmax(4*27.0e-3);
        bricks[1].Ymax(4*27.0e-3);
        bricks[1].Zmax(0);
        
        bricks[2] = new Brick();
        bricks[2].Material(this.m[5]);
        bricks[2].Xmin(-4*27.0e-3);
        bricks[2].Ymin(-4*27.0e-3);
        bricks[2].Zmin(-3.575e-3);
        bricks[2].Xmax(4*27.0e-3);
        bricks[2].Ymax(4*27.0e-3);
        ...
        bricks[3].Zmax(0);
        bricks[3].move(27.0e-3, 27.0e-3, 0);
        ...
        bricks[3].move(-4*27.0e-3, -4*27.0e-3, 0);
        bricks[4].move(-2*27.0e-3, -4*27.0e-3, 0);
        bricks[5].move(0*27.0e-3, -4*27.0e-3, 0);
        bricks[6].move(2*27.0e-3, -4*27.0e-3, 0);
        bricks[7].move(-4*27.0e-3, -2*27.0e-3, 0);
        bricks[8].move(-2*27.0e-3, -2*27.0e-3, 0);
        bricks[9].move(0*27.0e-3, -2*27.0e-3, 0);
        bricks[10].move(2*27.0e-3, -2*27.0e-3, 0);
        bricks[11].move(-4*27.0e-3, 0*27.0e-3, 0);
        bricks[12].move(-2*27.0e-3, 0*27.0e-3, 0);
        bricks[13].move(0*27.0e-3, 0*27.0e-3, 0);
        bricks[14].move(2*27.0e-3, 0*27.0e-3, 0);
        bricks[15].move(-4*27.0e-3, 2*27.0e-3, 0);
        bricks[15].move(-2*27.0e-3, 2*27.0e-3, 0);
        bricks[17].move(0*27.0e-3, 2*27.0e-3, 0);
        bricks[18].move(2*27.0e-3, 2*27.0e-3, 0);
    }
    ...
    private Brick CreateSimulationBox(){
        ...
        Brick b = new Brick();
        b.Material(this.m[1]);
        b.Xmin(-dimX-4*27.0e-3);
        b.Ymin(-dimY-4*27.0e-3);
        b.Zmin(-dimZ - 1.5e-3);
        b.Xmax(dimX+4*27.0e-3);
        b.Ymax(dimY+4*27.0e-3);
        b.Zmax(dimZ + 0);
        return b;
    }
    
    private void defineSources(){
        vs = new VoltageSource[2*16];
        
        vs[0] = this.createVoltageSouraceH(-4*27.0e-3, -4*27.0e-3, 1);
        vs[1] = this.createVoltageSouraceV(-4*27.0e-3, -4*27.0e-3, 0);
        
        vs[2] = this.createVoltageSouraceH(-2*27.0e-3, -4*27.0e-3, 1);
        vs[3] = this.createVoltageSouraceV(-2*27.0e-3, -4*27.0e-3, 0);
        
        vs[4] = this.createVoltageSouraceH(0*27.0e-3, -4*27.0e-3, 1);
        vs[5] = this.createVoltageSouraceV(0*27.0e-3, -4*27.0e-3, 0);
        
        vs[6] = this.createVoltageSouraceH(2*27.0e-3, -4*27.0e-3, 1);
        vs[7] = this.createVoltageSouraceV(2*27.0e-3, -4*27.0e-3, 0);
        
        vs[8] = this.createVoltageSouraceH(-4*27.0e-3, -2*27.0e-3, 1);
        vs[9] = this.createVoltageSouraceV(-4*27.0e-3, -2*27.0e-3, 0);
        
        vs[10] = this.createVoltageSouraceH(-2*27.0e-3, -2*27.0e-3, 1);
        vs[11] = this.createVoltageSouraceV(-2*27.0e-3, -2*27.0e-3, 0);
        
        vs[12] = this.createVoltageSouraceH(0*27.0e-3, -2*27.0e-3, 1);
        vs[13] = this.createVoltageSouraceV(0*27.0e-3, -2*27.0e-3, 0);
        
        vs[14] = this.createVoltageSouraceH(2*27.0e-3, -2*27.0e-3, 1);
        vs[15] = this.createVoltageSouraceV(2*27.0e-3, -2*27.0e-3, 0);
        
        vs[16] = this.createVoltageSouraceH(-4*27.0e-3, 0*27.0e-3, 1);
        vs[17] = this.createVoltageSouraceV(-4*27.0e-3, 0*27.0e-3, 0);
        
        vs[18] = this.createVoltageSouraceH(-2*27.0e-3, 0*27.0e-3, 1);
        vs[19] = this.createVoltageSouraceV(-2*27.0e-3, 0*27.0e-3, 0);
        
        vs[20] = this.createVoltageSouraceH(0*27.0e-3, 0*27.0e-3, 1);
        vs[21] = this.createVoltageSouraceV(0*27.0e-3, 0*27.0e-3, 0);
        
        vs[22] = this.createVoltageSouraceH(2*27.0e-3, 0*27.0e-3, 1);
        vs[23] = this.createVoltageSouraceV(2*27.0e-3, 0*27.0e-3, 0);
        
        vs[24] = this.createVoltageSouraceH(-4*27.0e-3, 2*27.0e-3, 1);
        vs[25] = this.createVoltageSouraceV(-4*27.0e-3, 2*27.0e-3, 0);
        
        vs[26] = this.createVoltageSouraceH(-2*27.0e-3, 2*27.0e-3, 1);
        vs[27] = this.createVoltageSouraceV(-2*27.0e-3, 2*27.0e-3, 0);
        
        vs[28] = this.createVoltageSouraceH(0*27.0e-3, 2*27.0e-3, 1);
        vs[29] = this.createVoltageSouraceV(0*27.0e-3, 2*27.0e-3, 0);
        
        vs[30] = this.createVoltageSouraceH(2*27.0e-3, 2*27.0e-3, 1);
        vs[31] = this.createVoltageSouraceV(2*27.0e-3, 2*27.0e-3, 0);
    }
        
    private VoltageSource createVoltageSouraceH(double shiftX, double shiftY, double mag){
        VoltageSource vsource = new VoltageSource(27.0e-3 , 34.0e-3, -1.5e-3, 27.0e-3, 34.0e-3, 0, c);
    ...
    private VoltageSource createVoltageSouraceV(double shiftX, double shiftY, double mag){
        VoltageSource vsource = new VoltageSource(34.0e-3, 27.0e-3, -1.5e-3, 34.0e-3, 27.0e-3, 0, c);
        vsource.move(shiftX, shiftY, 0);
        vsource.setDirection(Constants.ZP);
        vsource.setResistance(50.0);
        vsource.setMagnitude(mag);
    ...
    private void defineOutput(){
        ...
        ff = new FarField(2.75e9,2.85e9,5,c);
    ...
    private void timeMarchingLoop(){
        ...
        for (int timeIndex = 0; timeIndex < timeSteps; timeIndex++){
            ...
            if(timeIndex%(timeSteps/100) == 0){
                ...
                System.out.printf("****Finite-By-Finite - %d %% Done! ****  %d Seconds Remaining\n" , (100*timeIndex/timeSteps) , taskTimeMs*(timeSteps-timeIndex)/1000 );
            }
        }
    }
