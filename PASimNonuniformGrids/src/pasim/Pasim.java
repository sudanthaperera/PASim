...
public class Pasim {
    ...
    private void defineGeometry(){
        ...
        /*
        bricks[0] = new Brick(-1e-3, -1e-3, -3e-3, 81e-3, 81e-3, 5e-3, this.m[1]); //Air
        bricks[1] = new Brick(4e-3, 4e-3, 0, 76e-3, 76e-3, 1.5e-3, this.m[4]); //Dielectric
        bricks[2] = new Brick(4e-3, 4e-3, 0, 76e-3, 76e-3, 0, this.m[2]); //Ground
        bricks[3] = new Brick(25e-3, 25e-3, 1.5e-3, 55e-3, 55e-3, 1.5e-3, this.m[2]); //Patch  
        */
    ...
    private void defineOutput(){
        ...
        /*
        currentProbPos[0] = new Position(40e-3, 45e-3, 1.5e-3);
        voltageProbPos[0] = new Position(40e-3, 45e-3, 1.5e-3);
        eFieldProbPos[0] = new Position(40e-3, 45e-3, 1.5e-3);
        hFieldProbPos[0] = new Position(40e-3, 45e-3, 1.5e-3);
        */
        
        currentProbPos[0] = new Position(0, 5.25e-3, -1e-3);
        voltageProbPos[0] = new Position(0, 5.25e-3, 0);
        currentProbPos[1] = new Position(5.25e-3, 0, -1e-3);
        voltageProbPos[1] = new Position(5.25e-3, 0, 0);
