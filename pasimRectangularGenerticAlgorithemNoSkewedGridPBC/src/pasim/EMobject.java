...
public class EMobject {
    protected static int nx, ny, nz;
    protected static double[][][] Hx,Hy,Hz;
    protected static double[][][] Ex,Ey,Ez;
    protected static double[][][] Cexe,Cexhz,Cexhy,Ceye,Ceyhx,Ceyhz,Ceze,Cezhy,Cezhx;
    protected static double[][][] Chxh,Chxez,Chxey,Chyh,Chyex,Chyez,Chzh,Chzey,Chzex;
