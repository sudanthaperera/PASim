...
public class GeneticAlgorithm {
	...
	double populationFitness = 0;
        ...
        for (Individual individual : population.getIndividuals()) {
            Pasim pas = new Pasim(extractMetalPatch(individual.getChromosome()),extractPortPosition(individual.getChromosome()));
            pas.run();
            populationFitness += calcFitness(individual,pas);
