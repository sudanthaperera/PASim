...
public class GeneticAlgorithm {
    ...
    private int patchDimX, patchDimY;
    ...
    public Population initPopulation(int patchDimX, int patchDimY) {
	...
	Population population = new Population(this.populationSize, this.patchDimX*this.patchDimY);
	return population;
    }

    public double calcFitness(Individual individual, Pasim pas) {
	// Calculate fitness
	...
	double populationFitness = 0;
        ...
        for(int countIndividual = 0 ; countIndividual <= this.populationSize; countIndividual+=coreCount){
            ...
            Pasim[] pas = new Pasim[groupSize];
            
            for (int index = 0 ; index < groupSize ; index++) {
                pas[index] = new Pasim(extractMetalPatch(individual[countIndividual + index].getChromosome());
