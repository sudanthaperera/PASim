...
public class South implements Runnable {
    ...
    private void createAllBoundaries(){
        b = new Boundary();
        b.setAirBuffer(0,10,10);
        b.setCPML(false, true, true);
        b.setPBC(true, false, false);
        b.setCpmlCellNumber(0, 8, 8);
    ...
    private void defineGeometry(){
        ...
        bricks[1].Xmin(-27.0e-3);
        bricks[1].Ymin(-elementCount*27.0e-3);
        bricks[1].Zmin(-1.5e-3);
        bricks[1].Xmax(27.0e-3);
        bricks[1].Ymax(elementCount*27.0e-3);
        bricks[1].Zmax(0);
        
        bricks[2] = new Brick();
        bricks[2].Material(this.m[5]);
        bricks[2].Xmin(-27.0e-3);
        bricks[2].Ymin(-elementCount*27.0e-3);
        bricks[2].Zmin(-3.575e-3);
        bricks[2].Xmax(27.0e-3);
        bricks[2].Ymax(elementCount*27.0e-3);
        ...
        for(int i=1;i<(elementCount+1)/2;i++){
            ...
            bricks[2+i*2].move(0.0, -2*i*27.0e-3, 0);
                
            bricks[3+i*2] = new Brick(bricks[3]);
            bricks[3+i*2].move(0.0, +2*i*27.0e-3, 0);
        }
        /*
        bricks[4] = new Brick(bricks[3]);
        bricks[4].move(0.0, -2*27.0e-3, 0);
                
        bricks[5] = new Brick(bricks[3]);
        bricks[5].move(0.0, +2*27.0e-3, 0);
                
        bricks[6] = new Brick(bricks[3]);
        bricks[6].move(0.0, -4*27.0e-3, 0);
                
        bricks[7] = new Brick(bricks[3]);
        bricks[7].move(0.0, +4*27.0e-3, 0);
                
        bricks[8] = new Brick(bricks[3]);
        bricks[8].move(0.0, -6*27.0e-3, 0);
                
        bricks[9] = new Brick(bricks[3]);
        bricks[9].move(0.0, +6*27.0e-3, 0);
                
        bricks[10] = new Brick(bricks[3]);
        bricks[10].move(0.0, -8*27.0e-3, 0);
                
        bricks[11] = new Brick(bricks[3]);
        bricks[11].move(0.0, +8*27.0e-3, 0);
        
        bricks[12] = new Brick(bricks[3]);
        bricks[12].move(0.0, -10*27.0e-3, 0);
                
        bricks[13] = new Brick(bricks[3]);
        bricks[13].move(0.0, +10*27.0e-3, 0);
        
        bricks[14] = new Brick(bricks[3]);
        bricks[14].move(0.0, -12*27.0e-3, 0);
                
        bricks[15] = new Brick(bricks[3]);
        bricks[15].move(0.0, +12*27.0e-3, 0);
        
        bricks[16] = new Brick(bricks[3]);
        bricks[16].move(0.0, -14*27.0e-3, 0);
                
        bricks[17] = new Brick(bricks[3]);
        bricks[17].move(0.0, +14*27.0e-3, 0);
        
        bricks[18] = new Brick(bricks[3]);
        bricks[18].move(0.0, -16*27.0e-3, 0);
                
        bricks[19] = new Brick(bricks[3]);
        bricks[19].move(0.0, +16*27.0e-3, 0);
        
        bricks[20] = new Brick(bricks[3]);
        bricks[20].move(0.0, -18*27.0e-3, 0);
                
        bricks[21] = new Brick(bricks[3]);
        bricks[21].move(0.0, +18*27.0e-3, 0);
                */
    }
    ...
    private Brick CreateSimulationBox(){
        ...
        b.Material(this.m[1]);
        b.Xmin(-27.0e-3);
        b.Ymin(-dimY - (27.0e-3)*elementCount);
        b.Zmin(-dimZ - 1.5e-3);
        b.Xmax(27.0e-3);
        b.Ymax(dimY + (27.0e-3)*elementCount);
        b.Zmax(dimZ);
        return b;
    }
    ...
    private void defineSources(){
        ...
        for(int i=1;i<(elementCount+1)/2;i++){            
            vs[2+4*(i-1)] = this.createVoltageSouraceH(0, -2*i*27.0e-3, 1);
            vs[3+4*(i-1)] = this.createVoltageSouraceV(0, -2*i*27.0e-3, 0);
        
            vs[4+4*(i-1)] = this.createVoltageSouraceH(0, 2*i*27.0e-3, 1);
            vs[5+4*(i-1)] = this.createVoltageSouraceV(0, 2*i*27.0e-3, 0);
        }
        
        /*
        vs[2] = this.createVoltageSouraceH(0, -2*27.0e-3, 1);
        vs[3] = this.createVoltageSouraceV(0, -2*27.0e-3, 0);
        
        vs[4] = this.createVoltageSouraceH(0, 2*27.0e-3, 1);
        vs[5] = this.createVoltageSouraceV(0, 2*27.0e-3, 0);
        
        vs[6] = this.createVoltageSouraceH(0, -4*27.0e-3, 1);
        vs[7] = this.createVoltageSouraceV(0, -4*27.0e-3, 0);
        
        vs[8] = this.createVoltageSouraceH(0, 4*27.0e-3, 1);
        vs[9] = this.createVoltageSouraceV(0, 4*27.0e-3, 0);
        
        vs[10] = this.createVoltageSouraceH(0, -6*27.0e-3, 1);
        vs[11] = this.createVoltageSouraceV(0, -6*27.0e-3, 0);
        
        vs[12] = this.createVoltageSouraceH(0, 6*27.0e-3, 1);
        vs[13] = this.createVoltageSouraceV(0, 6*27.0e-3, 0);
        
        vs[14] = this.createVoltageSouraceH(0, -8*27.0e-3, 1);
        vs[15] = this.createVoltageSouraceV(0, -8*27.0e-3, 0);
        
        vs[16] = this.createVoltageSouraceH(0, 8*27.0e-3, 1);
        vs[17] = this.createVoltageSouraceV(0, 8*27.0e-3, 0);
        
        vs[18] = this.createVoltageSouraceH(0, -10*27.0e-3, 1);
        vs[19] = this.createVoltageSouraceV(0, -10*27.0e-3, 0);
        
        vs[20] = this.createVoltageSouraceH(0, 10*27.0e-3, 1);
        vs[21] = this.createVoltageSouraceV(0, 10*27.0e-3, 0);
        
        vs[22] = this.createVoltageSouraceH(0, -12*27.0e-3, 1);
        vs[23] = this.createVoltageSouraceV(0, -12*27.0e-3, 0);
        
        vs[24] = this.createVoltageSouraceH(0, 12*27.0e-3, 1);
        vs[25] = this.createVoltageSouraceV(0, 12*27.0e-3, 0);
        
        vs[26] = this.createVoltageSouraceH(0, -14*27.0e-3, 1);
        vs[27] = this.createVoltageSouraceV(0, -14*27.0e-3, 0);
        
        vs[28] = this.createVoltageSouraceH(0, 14*27.0e-3, 1);
        vs[29] = this.createVoltageSouraceV(0, 14*27.0e-3, 0);
        
        vs[30] = this.createVoltageSouraceH(0, -16*27.0e-3, 1);
        vs[31] = this.createVoltageSouraceV(0, -16*27.0e-3, 0);
        
        vs[32] = this.createVoltageSouraceH(0, 16*27.0e-3, 1);
        vs[33] = this.createVoltageSouraceV(0, 16*27.0e-3, 0);
        
        vs[34] = this.createVoltageSouraceH(0, -18*27.0e-3, 1);
        vs[35] = this.createVoltageSouraceV(0, -18*27.0e-3, 0);
        
        vs[36] = this.createVoltageSouraceH(0, 18*27.0e-3, 1);
        vs[37] = this.createVoltageSouraceV(0, 18*27.0e-3, 0);
                */
    }
    ...
    private void timeMarchingLoop(){
        ...
        for (int timeIndex = 0; timeIndex < timeSteps; timeIndex++){
            ...
            if(timeIndex%(timeSteps/100) == 0){
                ...
                System.out.printf("****Infinite-By-Finite - %d %% Done! ****  %d Seconds Remaining\n" , (100*timeIndex/timeSteps) , taskTimeMs*(timeSteps-timeIndex)/1000 );
            }
        }
    }
