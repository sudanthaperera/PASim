...
public class OptElementInstance implements Runnable {
    ...
    public OptElementInstance(int[][] patchMatrix,int[] protPosition){
    ...
    private void defineGeometry(int[][] patchMatrix){
        ...
        bricks[3] = new Brick();
        bricks[3].Material(this.m[4]);
        bricks[3].Xmin((-34.371e-3)/2);
        bricks[3].Ymin((-34.371e-3)/2);
        bricks[3].Zmin(0);
        bricks[3].Xmax((34.371e-3)/2);
        bricks[3].Ymax((34.371e-3)/2);
        bricks[3].Zmax(0);
    ...
    public double calcFitness(){
        ...
        fitness[0] = calcFitnessSparam(2.78e9, 2.82e9,"S11",-13);
        fitness[1] = calcFitnessSparam(2.76e9, 2.84e9,"S21",-65);
        //fitness[2] = 1*calcFitnessSparam(2.76e9, 2.84e9,"S11",-0.0001);
        //fitness[3] = 1*calcFitnessSparam(2.20e9, 3.40e9,"S21",-35);
        
        for(int index = 0; index < fitness.length;index++){
            totalFitness = totalFitness + fitness[index];
        }
        
        return totalFitness/2;
    }
