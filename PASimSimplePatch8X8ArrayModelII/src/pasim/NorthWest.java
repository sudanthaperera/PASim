...
public class NorthWest implements Runnable {
    ...
    private void createAllBoundaries(){
        ...
        b.setCPML(true, false, true, false, true, true);
    ...
    private void defineGeometry(){
        ...
        bricks[1].Xmin(-2*27.0e-3);
        bricks[1].Ymin(-2*27.0e-3);
        bricks[1].Zmin(-1.5e-3);
        bricks[1].Xmax(2*27.0e-3);
        bricks[1].Ymax(2*27.0e-3);
        bricks[1].Zmax(0);
        
        bricks[2] = new Brick();
        bricks[2].Material(this.m[5]);
        bricks[2].Xmin(-2*27.0e-3);
        bricks[2].Ymin(-2*27.0e-3);
        bricks[2].Zmin(-3.575e-3);
        bricks[2].Xmax(2*27.0e-3);
        bricks[2].Ymax(2*27.0e-3);
        ...
        bricks[3].move(0*27.0e-3, 0*27.0e-3, 0);
        bricks[4].move(-2*27.0e-3, -2*27.0e-3, 0);
        bricks[5].move(0*27.0e-3, -2*27.0e-3, 0);     
        bricks[6].move(-2*27.0e-3, 0*27.0e-3, 0);
    }
